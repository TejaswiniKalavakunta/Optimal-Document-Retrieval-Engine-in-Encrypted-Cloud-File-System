...
try {
	FileOutputStream fos = new FileOutputStream("D://December2021//DocumentRetrieval//WebContent//encfiles//"+encfilename);
...
sql="insert into upload(fname,actualfname,encryptedfilename,skeygenerated,skeyownergenerated,uid) values('"+s1+"','"+file+"','"+encfilename+"','"+encodedKey+"','"+ownerkey+"','"+s11+"')";
